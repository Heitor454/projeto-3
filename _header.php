...
<body>
    ...
    <div class="wrap">
        ...
        <!-- Cabeçalho -->
        <header>
            <a href="/"><img src="/img/log01.jpg" alt="Intranet"></a>
        ...
        <nav>
            ...
            <a href="/news.php"><i class="fas fa-fw fa-newspaper"></i> <span>Notícias</span></a>
            <a href="/contacts.php"><i class="fas fa-fw fa-comments"></i> <span>Contatos</span></a>
            <a href="/about.php"><i class="fas fa-fw fa-info-circle"></i> <span>Sobre</span></a>
        </nav>
